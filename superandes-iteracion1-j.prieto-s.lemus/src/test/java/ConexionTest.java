...
public class ConexionTest
{
	 ...
	 */
	private static final String CONFIG_TABLAS_A = "./src/main/resources/config/TablasBD_Superandes.json"; 
...
//			e.printStackTrace ();
			...
			JOptionPane.showMessageDialog(null, "No se encontró un archivo de configuración de tablas válido: ", "SuperandesTest", JOptionPane.ERROR_MESSAGE);
		}	
        return config;
    }	
}
