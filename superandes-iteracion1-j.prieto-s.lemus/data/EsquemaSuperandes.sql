...
-- Creación de la tabla PERECEDERO y especificación de sus restricciones
...
-- Creación de la tabla PEDIDO_BODEGA y especificación de sus restricciones
...
-- Creación de la tabla PERSONA_NATURAL y especificación de sus restricciones
...
-- Creación de la tabla PEDIDO_ABASTECIMIENTO y especificación de sus restricciones
...
-- Creación de la tabla REORDEN_SUCURSAL y especificación de sus restricciones
...
-- Creación de la tabla DETALLE_ORDEN y especificación de sus restricciones
...
CREATE TABLE SUCURSAL_PRODUCTO(
    ID_SUCURSAL NUMBER NOT NULL,
    CONSTRAINT FK_SUCURSAL_SUCURSALP FOREIGN KEY (ID_SUCURSAL)
    REFERENCES SUCURSAL(ID),
    ID_PRODUCTO VARCHAR2(255 BYTE) NOT NULL,
    CONSTRAINT FK_PRODUCTO_SUCURSALP FOREIGN KEY (ID_PRODUCTO)
    REFERENCES PRODUCTO(CODIGO_BARRAS),
